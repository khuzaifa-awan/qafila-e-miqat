...
function UmrahPackagesContent() {
  ...
  // Helper function to clear URL parameters and filters
  const clearAllFiltersAndParams = () => {
    // Clear URL parameters by pushing to history without query params
    window.history.pushState({}, '', '/umrah-packages');
    ...
    // Force reload the page to update searchParams
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <Button 
                variant="ghost" 
                size="sm" 
                onClick={clearAllFiltersAndParams}
              >
                Clear Selection
              </Button>
            </div>
